...
with k1:
    st.markdown(f"""<div class="metric-card">
        ...
        <div class="sub">{unique_materials:,} unique materials</div></div>""", unsafe_allow_html=True)
with k2:
    st.markdown(f"""<div class="metric-card" style="background:linear-gradient(135deg,#1a5c38,#27855a);">
        ...
        <div class="sub">{unique_products:,} unique products</div></div>""", unsafe_allow_html=True)
with k3:
    st.markdown(f"""<div class="metric-card" style="background:linear-gradient(135deg,#4a2070,#6d35a0);">
        ...
        <div class="sub">Across all batches</div></div>""", unsafe_allow_html=True)
